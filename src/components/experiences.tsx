...
const experiences = [
  ...
  },
  {
    ...
    description:
      "Helped lead a Project Operations implementation integrated with Business Central, co-designing the solution and managing end-to-end data migration to ensure accurate and timely go-live.",
